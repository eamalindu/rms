...
const batchDelete = ()=>{
    ...
    showCustomConfirm("You are About to Cancel this Batch<br><br>Batch Name: <span class='text-purple'>"+oldBatch.batchCode+"</span><br><br>Are You Sure?",function (result) {
        if(result){
